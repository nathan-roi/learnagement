...
{    
  ...
  $req = "INSERT INTO `INFO_parameters_of_views` (`id_parameters_of_views`, `userId`, `sessionId`, `id_semestre`, `id_module`, `id_discipline`, `id_enseignant`, `nom_filiere`) VALUES (NULL," .$userId . ",\"" . $sessionId . "\"," . $semestre . "," . $module . "," . $discipline . "," . $enseignant . ", " . $filiere . ") ON DUPLICATE KEY UPDATE userId=" . $userId  . ",id_semestre=" . $semestre . ",id_module=" . $module . ",id_discipline=" . $discipline . ",id_enseignant=" . $enseignant . ", nom_filiere=" . $filiere;
