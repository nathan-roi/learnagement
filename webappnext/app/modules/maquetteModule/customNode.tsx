...
function CustomNode({data, setDisplayCardCourse}: { data: any, setDisplayCardCourse: (course: any) => void}){
  ...
  const handleClick = (e: any) => {
    ...
    axios.post("/api/proxy/select/selectSeance", formData, {withCredentials: true})
        .then((response) => {
