<?php
    ...
    session_start();
    require_once("./src/main/web/fr/usmb/learnagement/repartitionChargeEnseignant/config.php");
    ...
    require("./src/main/web/fr/usmb/learnagement/repartitionChargeEnseignant/connectDB.php");
